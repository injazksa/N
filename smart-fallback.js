...
(function () {
  ...
  const FEMALE_PERMISSION = 'عدم ممانعة من ولي الأمر (في حالة كانت متزوجة إحضار شهادة الزواج وعدم الممانعة من الزوج + صورة عن جواز سفر الزوج) (في حال كانت عزباء، إحضار عدم ممانعة من ولي الأمر + قيد فردي + صورة عن جواز سفر ولي الأمر) إحضار جواز السفر و 6 صور شخصية بخلفية بيضاء حديثة لكافة المعاملات.';
  ...
  const MEDICAL_BIO = 'عمل فحص طبي وبصمة معتمد لدى السفارة السعودية.';
  ...
  function renderRequirements() {
    ...
    // V6 Deduplication: Ensure Passport/Photos is ONLY inside Military/Female Permission
    finalReqs = finalReqs.filter(r => {
        if (r === PASSPORT) return false;
        return true;
    });
